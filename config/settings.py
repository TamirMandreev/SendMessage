...
# SECRET_KEY используется для шифрования сессий пользователей,
# паролей и токенов CSRF
SECRET_KEY = os.getenv("SECRET_KEY")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True if os.getenv("DEBUG") == "True" else False

# ALLOWED_HOSTS определяет список хостов/доменов, с которых
# приложение может принимать запросы
ALLOWED_HOSTS = ["*"]
...
# django будет использовать вместо стандартной модели
# django.contrib.auth.models.User
AUTH_USER_MODEL = "users.User"

# URL-адреса, на которые пользователь будет перенаправляться после
# успешной аутентификации или выхода из учетной записи
LOGIN_REDIRECT_URL = "/"
LOGOUT_REDIRECT_URL = "/"
